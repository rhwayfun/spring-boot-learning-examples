package com.rhwayfun.springboot.quickstart.datasource.constants;
...
public abstract class DataSourceConstants {
    ...
    public static final String MAPPER_SECURITY_PACKAGE = "com.rhwayfun.springboot.security.datasource.mapper";
